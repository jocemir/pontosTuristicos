...
class _ListaPontosTuristicosPageState extends State<ListaPontosTuristicosPage>{
  ...
  Future<bool> _servicoHabilitado() async{
    ...
    if(!servicoHabilitado){
      await _mostrarMensagemDialog(
          'Para utilizar este recurso, é necessário acessar as configurações do dispositivo e conceder permissão para o acesso ao serviço de localização'
      );
  ...
  Future<bool> _verificaPermissoes() async{
    ...
    if(permissao == LocationPermission.deniedForever){
      await _mostrarMensagemDialog(
          'Para utilizar este recurso, é necessário acessar as configurações do dispositivo e permitir o acesso ao serviço de localização..'
      );
